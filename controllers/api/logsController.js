  ...
  try {
    if(Data.set_remainder === true) {
        let Data = {
            ...
            set_remainder : req.body.set_remainder,
            start_remainder_time: moment(req.body.start_remainder_time).format("YYYY-MM-DDThh:mm A"),
            end_remainder_time: moment(req.body.end_remainder_time).format("YYYY-MM-DDThh:mm A"),
    ...
    .send({ 
        ...
        else if (Data.set_remainder === false ) {
            let Data = {
                category_id : req.body.category_id,
                title : req.body.title,
                description : req.body.description,
